...
export default class PublicationMenu extends React.Component{
  constructor(props) {
    super(props);
  ...
  menuEdit = () => {
    ...
    navigate('NewPublication', { publication });
    this.toggleMenu();
  }
  ...
  report = () => {
    const { report, publication } = this.props;
  ...
  render() {
    ...
    return (
      <View>
        ...
        {this.state.menuOpen &&(
          <Animated.View style={[styles.menu, direction, {width: this.state.menuWidth, height: this.state.menuHeight}]}>
